...
To create your own dataset and compare algorithms in the same environment (recommended), please refer to this [code](https://github.com/AWCXV/MUFusion/blob/main/ir_vis/IV_patches/Generating_patches.py).
